...
class Graphene.TimeSeriesView extends Backbone.View
  ...
  initialize: ()->
    ...
    # sigsegv: d3 select changed from @parent to @el to fix rendering graph in rpi
    # see - http://stackoverflow.com/questions/11023852/rendering-in-backbone-js-using-d3-js-and-svgs
